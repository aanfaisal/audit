                  ...
                  <div class="x_content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    <tr>
                                        <th>No</th><td>{{ $bebanlain->bebanlain_id }}</td>
                                    </tr>
                                    <tr><th> Nama Ruang </th><td> {{ $bebanlain->nm_ruang }} </td></tr><tr><th> Jenis Beban </th><td> {{ $bebanlain->jns_beban }} </td></tr><tr><th> Jumlah Beban </th><td> {{ $bebanlain->jml_beban }} </td></tr>
                                </tbody>
                            </table>
                        </div>
