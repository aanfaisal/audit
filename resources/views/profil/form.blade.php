...
</div><div class="form-group {{ $errors->has('nama_institusi') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('jml_gedung') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('jml_lantai') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('jml_meter') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('meter_id') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('tot_daya') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('pnjng_gedung') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('lbr_gedung') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('tinggi_gedung') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('luas_gedung') ? 'has-error' : ''}}">
