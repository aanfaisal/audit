<div class="form-group {{ $errors->has('nm_ruang') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('jns_beban') ? 'has-error' : ''}}">
    {!! Form::label('jns_beban', 'Jns Beban', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
</div><div class="form-group {{ $errors->has('jml_beban') ? 'has-error' : ''}}">
    {!! Form::label('jml_beban', 'Jml Beban', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
</div><div class="form-group {{ $errors->has('daya_beban') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::text('wktu_pengukuran', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! $errors->first('wktu_pengukuran', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('tot_dayalain') ? 'has-error' : ''}}">
