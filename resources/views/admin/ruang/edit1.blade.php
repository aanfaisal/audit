          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Edit Data Ruangan Gedung</h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Data Ruangan Gedung</h2>
                      ...
                      <div id="app">
                                <h3>Data AC Ruang</h3>
                                    ...
                                    <div class="row" v-for="(item,index) in jawaban">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="number" placeholder="Jumlah AC" class="form-control" :name="'jml_ac['+index+']'" v-model="jml_ac[index].text" value="" required="" />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="number" placeholder="Total Daya AC (watt)" class="form-control" :name="'daya_ac['+index+']'" v-model="dya_ac[index].text" value="" required="" />
                                            </div>
                      ...
                      <div id="app2">
                                <h3>Data Beban Lain di Ruangan</h3>
                                    ...
                                    <div class="row" v-for="(item,index) in jawaban">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="number" placeholder="Jumlah Beban" class="form-control" :name="'jmlbebanlain['+index+']'" v-model="jmlbebanlain[index].text" value="" required="" />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="number" placeholder="Total Daya Beban (watt)" class="form-control" :name="'dyabebanlain['+index+']'" v-model="dyabebanlain[index].text" value="" required="" />
                                            </div>
                        ...
                        <div id="app3">
                                <h3>Data Beban Mesin di Ruangan</h3>
                                    ...
                                    <div class="row" v-for="(item,index) in jawaban">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="number" placeholder="Jumlah Mesin" class="form-control" :name="'jml_mesin['+index+']'" v-model="jml_mesin[index].text" value="" required="" />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
